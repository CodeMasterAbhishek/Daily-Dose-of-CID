...
import { renderArticles, renderStorylinesGrid, registerMasterArticles, updateFanDashboard, initializeIpCache, getCompletedWatchedList } from './ui.js';
...
async function init() {
    ...
    try {
        ...
        document.getElementById('news-container').innerHTML = '<p style="color:red">Failed to load CID dataset. Please try again later.</p>';
    }
}
